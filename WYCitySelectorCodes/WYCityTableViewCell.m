...
#import "WYCityCollectionViewCell.h"

#define kScreenWidth [UIScreen mainScreen].bounds.size.width
#define kScreenHeight [UIScreen mainScreen].bounds.size.height

@interface WYCityTableViewCell ()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>

@property (strong, nonatomic) UICollectionView *collectionView;

@end

@implementation WYCityTableViewCell
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WYCityCollectionViewCell *cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:cellReuseID forIndexPath:indexPath];
...
- (UICollectionView *)collectionView {
    ...
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[WYCityCollectionViewCell class] forCellWithReuseIdentifier:cellReuseID];
    }
